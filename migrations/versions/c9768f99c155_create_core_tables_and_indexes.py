...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "kind",
            sa.Enum("like", "share", "view", "bookmark", name="engagement_kind"),
            nullable=False,
        ),
        sa.Column("created_at", sa.DateTime(), nullable=False),
    ...
    op.create_index(
        "idx_posts_created", "posts", [sa.literal_column("created_at DESC")], unique=False
    )
    ...
    op.create_index(
        "idx_posthashtags_tag_post", "post_hashtags", ["hashtag_id", "post_id"], unique=False
    )
